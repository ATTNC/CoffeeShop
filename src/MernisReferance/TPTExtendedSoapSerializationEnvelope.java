...
public class TPTExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TPTDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TPTStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TPTDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TPTDateTimeConverter dateTimeConverter = new TPTStandardDateTimeConverter();

    public TPTExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TPTExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TPTMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TPTHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TPTExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TPTHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
