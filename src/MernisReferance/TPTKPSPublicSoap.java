...
public class TPTKPSPublicSoap
{
    ...
    public TPTKPSPublicSoap(){}

    public TPTKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TPTKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TPTExtendedSoapSerializationEnvelope envelope= new TPTExtendedSoapSerializationEnvelope(TPTExtendedSoapSerializationEnvelope.VER11);
